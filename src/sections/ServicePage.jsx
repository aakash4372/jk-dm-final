...
import Graphic from "./serviceimage/GRAPHIC DESINING.jpg";
import Video from "./serviceimage/VIDEOS EDITING SERVICE.jpg";
import vrvideo from "./serviceimage/VR 360 SERVICE.jpg";
import digitalMarketing from "./serviceimage/DIGITAL MARKETING.jpg";
import websiteDevelopment from "./serviceimage/WEBSITE CREATION.jpg";
...
// Import your video files (replace these with your actual video imports)
import graphicDesignVideo from "./serviceimage/GRAPHIC DESINING1.mp4";
import videoEditingVideo from "./serviceimage/VIDEO EDITING SERVICE.mp4";
import vrVideosVideo from "./serviceimage/VIDEO EDITING SERVICE.mp4";
import digitalMarketingVideo from "./serviceimage/DIGITAL MARKETING VIDEO.mp4";
import websiteDevelopmentVideo from "./serviceimage/WEBSITE CREATION1.mp4";

const GraphicDesignSection = () => {
  const [showMagazineDesc, setShowMagazineDesc] = useState(false);
  ...
  return (
    <div className="service-section">
      ...
      <div className="graphic-design-container pt-20">
            ...
            {[
              ...
              <li
                ...
                className={`service-item ${
                  service === "Magazine Layouts" ? "clickable" : ""
                }`}
                onClick={
